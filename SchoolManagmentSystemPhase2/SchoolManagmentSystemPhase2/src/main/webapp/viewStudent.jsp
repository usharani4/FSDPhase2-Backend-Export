...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/SchoolManagmentSystemPhase2'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="/SchoolManagmentSystemPhase2/Dashboard.jsp">Dashboard</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
...
<%} else{
response.sendRedirect("/SchoolManagmentSystemPhase2/Dashboard.jsp");
%>
